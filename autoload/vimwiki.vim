...
function! vimwiki#setup_colors() "{{{
  ...
  if &background == 'light'
    ...
    hi def VimwikiHeader1 guibg=bg guifg=#FF0000 gui=bold ctermfg=DarkRed
    hi def VimwikiHeader2 guibg=bg guifg=#00FF00 gui=bold ctermfg=DarkGreen
    hi def VimwikiHeader3 guibg=bg guifg=#0000FF gui=bold ctermfg=DarkBlue
    hi def VimwikiHeader4 guibg=bg guifg=#FF00FF gui=bold ctermfg=Black
    hi def VimwikiHeader5 guibg=bg guifg=#00FFFF gui=bold ctermfg=Black
    hi def VimwikiHeader6 guibg=bg guifg=#FFFF00 gui=bold ctermfg=Black
  else
